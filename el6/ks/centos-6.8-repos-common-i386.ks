...
repo --name=epel    --mirrorlist=https://mirrors.fedoraproject.org/mirrorlist?repo=epel-6&arch=i386
...
repo --name=elrepo    --baseurl=http://elrepo.org/linux/elrepo/el6/i386/    --include=elrepo-release,kmod-e1000,kmod-e1000e,kmod-r8168,kmod-r8169
repo --name=rpmforge    --baseurl=http://apt.sw.be/redhat/el6/en/i386/rpmforge/    --include=fuse-cryptofs,fuse-iso,lha,numlockx,realpath,rpmforge-release,synergy,unrar,wput
